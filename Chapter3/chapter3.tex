...
\label{sec:Excitation-Methods}
	...
	\label{sec:Excitation-BWE}
		...
		\begin{figure}[h!]
			\centering
			\subfloat[Spectral Folding]{\includegraphics[width=0.4\textwidth]{Chapter3/Images/SpectralFolding.png}}
			\subfloat[Spectral Replication]{\includegraphics[width=0.4\textwidth]{Chapter3/Images/SpectralReplication.png}}
			\\
			\subfloat[Spectral Stretching]{\includegraphics[width=0.4\textwidth]{Chapter3/Images/SpectralStretching.png}}
