...
\label{sec:Excitation-Timbre}
	...
	participants are asked to rate the timbral characteristics of nonlinearly processed stimuli. The section reviews
...
\label{sec:Excitation-Methods}
	...
	\label{sec:Excitation-Methods-IAP}
		...
		its amplitude.  Equation~\ref{eq:IAP} shows the $h$\super{th} order instantaneous amplitude and phase
