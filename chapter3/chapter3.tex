...
\label{sec:Excitation-Methods}
	...
	\label{sec:Excitation-Statics}
		...
		\subsubsection*{Temporal Characteristics}
			...
			a large scale. There is a possibility to affect the attack time of signals slightly through
			increasing the gradient of the low amplitude section characteristic curve. As an extreme example
			...
			\note{This can make the attack and release instantaneous. Perhaps a plot showing this.}
