...
\label{sec:Excitation-AnalysisOfNonlinearSystems}
	...
	\label{sec:Excitation-Analysis-Components}
		...
		\subsubsection*{Aliasing}
			...
			for a given frequency in the input signal, $f$, is the displacement between the frequency and the
			nearest integer multiple of the sampling frequency (Equation \ref{eq:aliasing}).
