...
\label{sec:Excitation-AnalysisOfNonlinearSystems}
	...
	to calculate the response of the system to an arbitrary input signal, $x[n]$, via convolution
	...
	\label{sec:Excitation-Analysis-Metrics}
		...
		\subsubsection*{Psychoacoustically Influenced Metrics}
			...
			perceived through analysis of its characteristic curve, $T(x)$. It is calculated using
			Equation~\ref{eq:gedlee}.
...
\label{sec:Excitation-Methods}
	...
	\label{sec:Excitation-Methods-IAP}
		...
		$h$\super{th} order instantaneous amplitude and phase modulation of a signal.
