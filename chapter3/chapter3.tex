...
%		\subsubsection*{Naturalness}
	...
	\label{sec:Excitation-SSB}
		...
		\citet{oppenheim2014discrete} suggest processing audio with two parallel allpass IIR filters the phase
		responses of which differ from each other by $\frac{\pi}{2}$ radians for a large proportion of the
		spectrum. The outputs of these two filters can then be used as the real and imaginary parts of the analytic
		signal. \citet{niemitalo2003hilbert} suggests such a set of filters.
		...
		\subsubsection*{Spectral Characteristics}
			\note
			{
				SSBA extends the control of multipliers as it constrains the minimum frequency introduced
