...
\label{sec:Excitation-Systems}
	...
	\label{sec:Excitation-Fundamental}
		...
		it is in other fields, such as automatic music transcription. The lag between the audio and the estimate of
		the fundamental frequency is of more concern.

		\note
		{
			This wont work where there is little energy at the fundamental!
		}
