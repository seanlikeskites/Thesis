...
\label{sec:Excitation-Uses}
	...
	\begin{itemize}
		...
		\item To reconstruct high frequency information in perceptual audio compression codecs. In these codecs the
		      bandwidth of an audio signal is reduced to minimise the amount of data. When the signal is
		      reconstructed harmonic excitation is used to extend the bandwidth again.
		\item To extend the perceived bandwidth of loudspeakers. Small loudspeakers cannot physically reproduce low
		      frequencies signals. Harmonic excitation can be used to allow listeners to perceive low frequencies
		      from small loudspeakers.
	...
	\subsection{Audio Enhancers}
	\label{sec:Excitation-Uses-Enhancers}
