...
\label{sec:Excitation-Systems}
	...
	\label{sec:Excitation-Individuals}
		...
		to reconstruct signals which from which some harmonic content removed. The quality of the reconstruction
		was assessed by participants in a multiple stimulus listening test. 

		Four different audio samples were used consisting of:
