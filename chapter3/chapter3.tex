...
\label{sec:Excitation-Evaluation}
	...
	\label{sec:Excitation-Evaluation-TemporalCharacteristics}
		One of the properties of a signal which contributes to its timbre is how it evolves over time. \note{Some
		bloke has probably said something about how attack time correlates with softness or some bullshit, cite him}
