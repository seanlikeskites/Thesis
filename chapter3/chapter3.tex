...
\label{sec:Excitation-Methods}
	...
	\label{sec:Excitation-Methods-SSBA}
		...
		With more thorough analysis it can be shown that the intermodulation components produced through single
		sideband modulation all take the same form as shown in Equation \ref{eq:IntermodulationComponents} but
		where the scaling factors, $k_{n}$, are all positive integers.
