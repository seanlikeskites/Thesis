...
%		\subsubsection*{Naturalness}
	...
	\label{sec:Excitation-SpectralFolding}
		...
		order for the output signal to have the same sampling frequency as the input the signal us 
		downsampled by a factor $k$ before upsampling by the same factor. 
