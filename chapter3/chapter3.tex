...
\label{sec:Excitation-Systems}
	...
	\label{sec:Excitation-Fundamental}
		...
		sufficient magnitude can be isolated and used as the input to the exciter.
	...
	\label{sec:Excitation-Individuals}
		...
		These harmonics where then reintroduced using the SSBA, IAP and a synthesis method. The synthesis method
		consisted of using the STFT to measure the amplitude envelope of the fundamental frequency and applying
		this to a synthesised sine wave at the frequency of the desired harmonic. 
