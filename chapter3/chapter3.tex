...
\label{sec:Excitation-Systems}
	...
	\label{sec:Excitation-Individuals}
		...
		\begin{figure}[h!]
			...
			\caption{Spectrograms of the cello sample reconstructed using the three methods.}
		...
		was graded with the R\sub{nonlin} metric. These results were normailised to the same range as the results
		from the listeneing test and are displayed in Figure \ref{fig:SMCRNonlin}.
