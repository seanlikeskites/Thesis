...
\label{sec:Excitation-AnalysisOfNonlinearSystems}
	...
	\label{sec:Excitation-AnalysisOfNonlinearSystems-Components}
		...
		\subsubsection*{Aliasing}
			...
			\note{Probably move the rest of this section to later on.}
	...
	\label{sec:Excitation-Analysis-Metrics}
		...
		of two sinusoids is measured. \note{The \citet{IEC2003loudspeakers} standard is the one we'll talk about.}.
