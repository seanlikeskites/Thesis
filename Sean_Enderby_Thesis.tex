...
% glossary entries
\usepackage[acronym, style=super, nonumberlist, nogroupskip]{glossaries}
...
\newglossaryentry{maths:setcomp}
{
	type=maths,
	name={$B \setminus A$},
	description={the relative complement of set $A$ with respect to set $B$ (the elements in $B$ which are not in
		     $A$)},
	sort={comp}
}
