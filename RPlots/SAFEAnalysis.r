...
par(mar=c(4, 4, 0.2, 0.2))
a <- plotIndividualPCA(eqProcPCAPointsSel, c(3, 2), "topleft", c(0.25, 0, 0, 0))
dev.off()
...
par(mar=c(4, 4, 0.2, 0.2))
a <- plotIndividualPCA(eqDiffPCAPointsSel, c(1, 2), "topright", c(0, 0.3, 0, 0))
dev.off()
...
par(mar=c(4, 4, 0.2, 0.2))
a <- plotIndividualPCA(eqDiffPCAPointsSel, c(3, 2), "bottomright", c(0, 0.1, 0, 0))
dev.off()
...
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(distProcPCA, c(1, 2), distDescriptors, distProcPlotFeatures1, c(0.1, 0.15, 0, 0.1))
dev.off()
...
pdf("DistortionProcessedCentroidsPCA3-2.pdf", pointsize=plotPointSize, fonts=c("CM Roman", "CM Sans"), family="CM Sans",
    width=2.95, height=2.95)
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(distProcPCA, c(3, 2), distDescriptors, distProcPlotFeatures2, c(0.2, 1, 0, 0.1))
dev.off()
...
pdf("EqualiserDifferenceCentroidsPCA1-2.pdf", pointsize=plotPointSize, fonts=c("CM Roman","CM Sans"), family="CM Sans",
    width=pcaPlotSize, height=pcaPlotSize)
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(eqDiffPCA, c(1, 2), eqDescriptors, eqDiffPlotFeatures1, c(0.1, 0.05, 0.02, 0))
dev.off()
...
plotSpectralChange(distProcSel, distUnprocSel, "bottomleft", 2)
dev.off()
...
plotSpectrum(eqProcSel, "topright", 4, c(0, 0.2))
dev.off()
...
plotSpectralChange(eqProcSel, eqUnprocSel, "topleft", 2, c(0, 0.15))
dev.off()
