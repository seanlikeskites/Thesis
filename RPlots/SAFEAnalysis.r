...
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(distProcPCA, distDescriptors, distProcPlotFeatures, c(0.9, 0.2, 0, 0.1))
dev.off()
...
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(distDiffPCA, distDescriptors, distDiffPlotFeatures, c(0.15, 1, 0, 0.05))
dev.off()
...
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(eqProcPCA, eqDescriptors, eqProcPlotFeatures, c(0.2, 1, 0.15, 0.05))
dev.off()
...
par(mar=c(4, 4, 2, 2))
a <- plotCentroidBiplot(eqDiffPCA, eqDescriptors, eqDiffPlotFeatures, c(0.5, 0.5, 0.05, 0.05))
dev.off()
