...
dev.off()
embed_fonts("DistortionProcessedCentroidsPCA.eps")
...
dev.off()
embed_fonts("DistortionDifferenceCentroidsPCA.eps")
...
dev.off()
embed_fonts("EqualiserProcessedCentroidsPCA.eps")
...
dev.off()
embed_fonts("EqualiserDifferenceCentroidsPCA.eps")
