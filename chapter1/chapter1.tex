...
\label{sec:Introduction-ThesisStructure}
	...
	and how audio effects are used to produce certain timbral effects.
	...
	which can be used to provide monotonic control over a specific property of the input signal. The operation of these
	systems is evaluated using a number of test signals.
	...
	dataset gathered in Chapter~\ref{chap:TimbreEvaluation}, and objectively, through a series of perceptual listening
	tests.
