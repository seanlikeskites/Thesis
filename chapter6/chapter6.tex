...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-Inharmonicity}
		...
		has a significant amount of energy at perfectly harmonic partials giving it a low inharmonicity. This
		...
		effect on the overall inharmonicity. The issue of higher order harmonics reducing the maximum inharmonicity
		could be counteracted by adding an addition frequency shifter to the system. This shifter would operate on
		the filtered input signal and shift all the higher order partials by the same amount.

\section{Conclusions}
\label{sec:FeatureControl-Conclusions}
	\note
	{
		Write some kind of summary of the chapter here.
	}
