...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-HarmonicParityRatio}
		...
		\subsubsection*{Manipulation of The Odd to Even Harmonic Ratio}
			...
			An example method of how the system in Figure \ref{fig:HarmonicParitySystem} can be used is as
	...
	\label{sec:FeatureControl-Parameterisation-Inharmonicity}
		...
		\note{First 9 harmonics generated perfectly and with increasing inharmonicity (0.1 to 0.5). These two are
		then summed together at different ratios.}
