...
\label{sec:FeatureControl-Parameterisation}
	...
	techniques. For	example, control of the \acr{mfccs} involves the manipulation of several frequency bands, a task
	better suited to an equalisation system. The spectral features parameterised in this section are the spectral
