...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-Tristimulus}
		...
		The parameter represents the gain applied to the isolated fundamental.
		...
		isolated fundamental signal contains energy in some of the lower order spectral partials. In sounds where
