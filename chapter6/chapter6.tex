...
\label{sec:FeatureControl-Systems}
	Section \ref{sec:ExcitationEvaluation-Methods} covered several different methods of introducing new frequency content to a
	...
	\label{sec:FeatureControl-Systems-Fundamental}
		The majority of the methods discussed in Section \ref{sec:ExcitationEvaluation-Methods} will cause intermodulation
	...
	\label{sec:FeatureControl-Systems-Individuals}
		...
		\begin{figure}[h!]
			...
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloSpectrogram.eps}
				\label{fig:CelloSpectrogram}
			}
			\qquad
			\subfloat[Filtered Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloFilteredSpectrogram.eps}
		...
		\begin{figure}[h!]
			...
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloSSBASpectrogram.eps}
				\label{fig:CelloSSBASpectrogram}
			}
			\qquad
			\subfloat[IAP with a 50\super{th} order filter.]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloIAPSpectrogram.eps}
				\label{fig:CelloIAPSpectrogram}
			}
			
			\subfloat[Synthesis with an STFT window length of 50 samples.]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloSynthesisSpectrogram.eps}
		...
		\begin{figure}[h!]
			...
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloResults.eps}
				\label{fig:CelloResults}
			}
			\qquad
			\subfloat[Clarinet Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/ClarinetResults.eps}
				\label{fig:ClarinetResults}
			}

			\subfloat[Synthesised Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/SynthResults.eps}
				\label{fig:SynthResults}
			}
			\qquad
			\subfloat[Piano Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/PianoResults.eps}
		...
		\begin{figure}[h!]
			...
			\subfloat[Cello Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/CelloRNonlin.eps}
				\label{fig:CelloRNonlin}
			}
			\qquad
			\subfloat[Clarinet Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/ClarinetRNonlin.eps}
				\label{fig:ClarinetRNonlin}
			}

			\subfloat[Synthesised Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/SynthRNonlin.eps}
				\label{fig:SynthRNonlin}
			}
			\qquad
			\subfloat[Piano Sample]
			{
				\includegraphics[width=0.45\textwidth]{chapter6/Images/PianoRNonlin.eps}
		...
		section \ref{sec:ExcitationEvaluation-Methods-IAP} that it is a homogeneous process allowing it to be applied to
	...
	\label{sec:FeatureControl-Systems-Inharmonicity}
		...
		\ref{sec:ExcitationEvaluation-Methods-SpectralReplication}. This produces partials which deviate from harmonic
...
\label{sec:FeatureControl-Control}
	...
	\label{sec:FeatureControl-Control-Slope}
		As discussed in Section \ref{sec:ExcitationEvaluation-Methods-Statics} the spectral slope of the band of
		distortion components generated using a static nonlinearity depends on the continuity of the nonlinearity's
		characteristic curve and its derivatives. Using a simple system, similar to that in Figure
		\ref{fig:F0Tracking}, the characteristic curve of the nonlinearity can be changed to influence the spectral
		slope of the output signal.
