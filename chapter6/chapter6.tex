...
\label{sec:FeatureControl-Introduction}
	...
	and which excitation algorithms are the most suitable for given feature changes. Firstly, in
...
\label{sec:FeatureControl-Parameterisation}
	...
	how the excitation systems perform for the ideal case of a harmonic signal with zero noise. The piano signal is
