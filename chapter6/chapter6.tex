...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-SpectralMoments}
		...
		\subsubsection*{Manipulation of The Higher Order Spectral Moments}
			...
			Only controlling the amplitudes of the first nine harmonics imposes restriction of how the spectral
			...
			order harmonics of the signal. This is seen in Figure \ref{fig:MoveSkewess} where the skewness
