...
\label{sec:FeatureControl-Introduction}
	...
	are discusses and methods to counteract them are suggested. A number of different systems are proposed which
	provide precise control over the distortion components introduced to a signal. In Section
