...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-SpectralMoments}
		...
		\subsubsection*{Manipulation of The Higher Order Spectral Moments}
			...
			desired gain. Figure \ref{fig:MoveSpreads} shows the effect on the spectral spread when this band
			contains energy between 0.8 and 1.2 of the spectral centroid. The parameter determines the gain
			applied to the excited band.
			...
			effect of this on the spectral skewness of the test signals. The parameter represent the gradient
			of the tilt applied to the spectrum.
			...
			signal when undergoing the same processing as describe for Figure \ref{fig:MoveSpreads}.
