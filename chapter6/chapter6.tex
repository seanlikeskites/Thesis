...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-HarmonicParityRatio}
		...
		\begin{equation}
			m = \sqrt{\frac{\textrm{ROE}\sum_{1 \leq n \leq N, n \textrm{ is even}} h_{n}^{2}}
				       {\sum_{1 \leq n \leq N, n \textrm{ is odd}} h_{n}^{2}}},
				       \quad \textrm{ROE} \geq 0;
		...
		The cello and synthesised signals both exhibit a limit on how high the $R_{\textrm{OE}}$ can be made. This
		...
		The system discussed here provides no control over the $R_{\textrm{OE}}$ of the piano signal. This is again
