...
%			problematic task is how to construct these two signals.
	...
	\label{sec:FeatureControl-Parameterisation-Irregularity}
		...
		\subsubsection*{Manipulation of Irregularity}
			...
			value can be increased or reduced by moving the amplitudes of the partials away or towards the mean
			amplitude of all the partials. To implement this using the system shown in Figure
			\ref{fig:InhamronicictySystem} the new amplitudes of the first nine harmonics can be calculated
			using Equation \ref{eq:PartialSmoothing}
			...
			$n$\super{th} partial in the input signal and $P$ is a parameter.

			The effects of changing parameter $P$ when processing the test signals are shown in Figure
			\ref{fig:MoveIrregularities}.
