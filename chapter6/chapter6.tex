...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-Tristimulus}
		...
		\begin{figure}[h!]
			...
			\caption{Manipulating the Tristimulus 1 of the Test Signals.}
			\label{fig:MoveKurtoses}
		\end{figure}
		...
		\begin{figure}[h!]
			...
			\caption{Manipulating the Tristimulus 2 of the Test Signals.}
			\label{fig:MoveKurtoses}
		\end{figure}
		...
		\begin{figure}[h!]
			...
			\caption{Manipulating the Tristimulus 3 of the Test Signals.}
			\label{fig:MoveKurtoses}
		\end{figure}
