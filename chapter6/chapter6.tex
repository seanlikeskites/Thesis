...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-SpectralMoments}
		...
		\subsubsection*{Manipulation of The Higher Order Spectral Moments}
			...
			\note{Tilt is applied about the spectral centroid using the equations bleugh and bleugh.}
			...
			\note
			{
				Some discussion. This method has a minimum value for the skewness as the centroid typically
				lies in the high order harmonics over which we don't have the same degree of control.
				Adding high order filters and using an nld with lots of gain could decrease the skewness
				further.
			}
