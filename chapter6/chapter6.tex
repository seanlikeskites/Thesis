...
\label{sec:FeatureControl-Summary}
	\begin{table}[h!]
		...
		\begin{tabular}{|c|c|C{4cm}|c|}
			...
			\hline
			\hline
			$\mu_{\mathrm{s}}$ & Figure~\ref{fig:TwoBandSpectralCentroidSystem} & 
			Any which generate a large band of harmonic energy, e.g. static nonlinearities. & 
			Yes \tabularnewline			
			\hline
			Spectral Spread & Figure~\ref{fig:TwoBandSpectralCentroidSystem} & 
			Any which generate a large band of harmonic energy, e.g. static nonlinearities. & 
			Yes \tabularnewline			
			\hline
			Spectral Irregularity & & & \tabularnewline			
			\hline
			Spectral Flatness & & & \tabularnewline			
			\hline
			Spectral Slope & & & \tabularnewline			
			\hline
			Tristimulus & & & \tabularnewline			
			\hline
			$\mathrm{OER}$ & & & \tabularnewline			
			\hline
			Inharmonicity & & & \tabularnewline			
			\hline
		\end{tabular}
	\end{table}
