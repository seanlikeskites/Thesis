...
\label{sec:FeatureControl-Parameterisation}
	...
	The cello and clarinet samples both represent typical recorded harmonic sounds. Both are composed of harmonic
	...
	\label{sec:FeatureControl-Parameterisation-SpectralMoments}
		\subsubsection*{Parameterisation of The Spectral Centroid}
			...
			\begin{figure}[h!]
				\centering
				\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveCentroids.tex}}
		...
		\subsubsection*{Parameterisation of The Higher Order Spectral Moments}
			...
			\begin{figure}[h!]
				\centering
				\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveSpreads.tex}}
			...
			\begin{figure}[h!]
				\centering
				\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveSkewnesses.tex}}
			...
			\begin{figure}[h!]
				\centering
				\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveKurtoses.tex}}
	...
	\label{sec:FeatureControl-Parameterisation-Irregularity}
		...
		\begin{figure}[h!]
			...
			{
				\resizebox{0.45\textwidth}{!}{\input{chapter6/Images/MoveIrregularitiesK.tex}}
				\label{fig:MoveIrregularitiesK}
			}
			\qquad
			\subfloat[Jensen Irregularity]
			{
				\resizebox{0.45\textwidth}{!}{\input{chapter6/Images/MoveIrregularitiesJ.tex}}
				\label{fig:MoveIrregularitiesJ}
			}
			
			\subfloat[Beauchamp Irregularity]
			{
				\resizebox{0.45\textwidth}{!}{\input{chapter6/Images/MoveIrregularitiesB.tex}}
	...
	\label{sec:FeatureControl-Parameterisation-Flatness}
		...
		A greater degree of control can be achieved over the spectral flatness by altering the power spectrum such
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveFlatnesses.tex}}
	...
	\label{sec:FeatureControl-Parameterisation-Slope}
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveSlopes.tex}}
	...
	\label{sec:FeatureControl-Parameterisation-Tristimulus}
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveTristimulus1.tex}}
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveTristimulus2.tex}}
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveTristimulus3.tex}}
	...
	\label{sec:FeatureControl-Parameterisation-HarmonicParityRatio}
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveParities.tex}}
	...
	\label{sec:FeatureControl-Parameterisation-Inharmonicity}
		...
		\begin{figure}[h!]
			\centering
			\resizebox{0.6\textwidth}{!}{\input{chapter6/Images/MoveInharmonicities.tex}}
