...
\label{sec:FeatureControl-Control}
	...
	\label{sec:FeatureControl-Control-Slope}
		As discussed in Section \ref{sec:Excitation-Methods-Statics} the spectral slope of the band of distortion
		components generated using a static nonlinearity depends on the continuity of the nonlinearity's
