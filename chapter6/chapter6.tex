...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-Slope}
		\subsubsection*{Manipulation of Spectral Slope}
			...
			harmonics in this manner reduces complexity at the cost of precise control of the spectral slope.
	...
	\label{sec:FeatureControl-Parameterisation-HarmonicParityRatio}
		...
		\subsubsection*{Manipulation of Odd to Even Harmonic Ratio}
			...
			superposition to occur sacrifices precise control in order to maintain some of the input's
			characteristics.
			...
			The cello and synthesised samples both exhibit a limit on how high the $R_{\textrm{OE}}$ can be
