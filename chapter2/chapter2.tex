...
\label{sec:Timbre-Parameterisation}
	...
	\label{sec:Timbre-Parameterisation-DimensionalityReduction}
		...
		VAME experiment.  \citet{zacharakis2012analysis} also performed a VAME test but choose to use
		\acrshort{efa} over \acrshort{pca} stating that \acrshort{efa} better explains the relationships between
		the separate attribute scales.
	...
	\label{sec:Timbre-DimensionalityReduction-DimensionCorrelations}
		...
		can be though of as timbral synonyms, being used similarly when rating the set of stimuli used for the
		test.
