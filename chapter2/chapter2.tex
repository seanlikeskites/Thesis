...
\label{sec:Timbre-ListeningTests}
	...
	\label{sec:Timbre-ListeningTests-Environments}
		...
		undergo the test. Perceptual audio test necessarily involve the use of audio reproduction equipment and
		some means of recording the participant's responses. The reproduction system and response method chosen has
		impacts on the reliability of the reconstruction and the sample size of participants. Two common approaches
		are to run supervised listening tests with specific reproduction equipment in a laboratory, or to
		distribute test over the internet.
