...
\label{sec:Timbre-Introduction}
	...
	methods of controlling timbral aspects of a signal proposed in the research literature, and
...
\label{sec:Timbre-PsychoacousticPrinciples}
	...
	\label{sec:Timbre-PsychoacousticPrinciples-CriticalBands}
		...
		bandwidth of these filters is known as the equivalent rectangular bandwidth ($\mathrm{ERB}$) and can be
...
\label{sec:Timbre-ListeningTests}
	...
	\label{sec:Timbre-ListeningTests-Methods}
		...
		\subsubsection*{Dissimilarity Tests}
			...
			are to a reference signal (the uncompressed version) on a scale from 0 to 100. Among the signals to
			be graded are a hidden reference and anchor which are used to evaluate the reliability of a
...
\label{sec:Timbre-AudioProcessing}
	...
	\label{sec:Timbre-AudioProcessing-Nonlinear}
		...
		\subsubsection*{Dynamics Processing}
			...
			describe the application of compression in the SAFE dataset are: punchy, tight, smooth, squashed,
			snappy and crushed.
