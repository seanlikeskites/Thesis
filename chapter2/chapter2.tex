...
\label{sec:Timbre-LowLevelFeatures}
	...
	\label{sec:Timbre-LowLevelFeatures-Spectral}
		...
		\subsubsection*{Tristimulus}
			...
			giving the peak tristimulus measures $T_{\mathrm{p}1}$, $T_{\mathrm{p}2}$ and $T_{\mathrm{p}3}$.
		...
		\subsubsection*{Odd to Even Harmonic Ratio}
			...
			\begin{equation}
				\mathrm{OER} = \frac{\sum_{1 \leq n \leq N, n \mathrm{ is odd}} h_{n}^{2}}
					       {\sum_{1 \leq n \leq N, n \mathrm{ is even}} h_{n}^{2}}
			...
			\begin{equation}
				O = \sqrt{\frac{\sum_{1 \leq n \leq N, n \mathrm{ is odd}} h_{n}^{2}}
					       {\sum_{n = 1}^{N} h_{n}^{2}}}
				\label{eq:Oddness}
			\end{equation}

			\begin{equation}
				E = \sqrt{\frac{\sum_{1 \leq n \leq N, n \mathrm{ is even}} h_{n}^{2}}
					       {\sum_{n = 1}^{N} h_{n}^{2}}}
				\label{eq:Evenness}
			\end{equation}
