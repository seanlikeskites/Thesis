...
\label{sec:Timbre-PsychoacousticPrinciples}
	...
	\label{sec:Timbre-PsychoacousticPrinciples-Frequency}
		...
		bands. One such metric are the \acrfullpl{mfcc} developed for use in speech recognition
...
\label{sec:Timbre-Parameterisation}
	...
	\label{sec:Timbre-DimensionalityReduction-DimensionCorrelations}
		...
		\citet{alluri2010exploring} take a more in depth approach, using stepwise and principal components
		...
		flux in the 3\super{rd}, 6\super{th} and 8\super{th} of 10 spectral bands. The `Brightness' dimension
		comprises zero crossing rate and the 1\super{st} and 3\super{rd} bands' fluxes and the `Fullness' dimension
		is described by zero crossing rate, high-low energy ratio, entropy and the 2\super{nd} band's flux.
