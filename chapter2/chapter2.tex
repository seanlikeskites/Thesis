...
\label{sec:Timbre-PsychoacousticPrinciples}
	...
	Where $f_{c}$ is the center frequency of the auditory filter in kHz and $ERB(f_{c})$ is the equivalent rectangular
	bandwidth, in Hz, at that frequency.

	\citet{howard2009acoustics} discusses the perception of two tones as they get further apart in frequency.
	...
	\begin{figure}[h!]
		...
		\end{tikzpicture}
		\caption{The perceived of two tones as they move further apart in frequency. CB denotes the critical
		bandwidth.}
