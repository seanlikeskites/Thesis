...
\label{sec:Timbre-PsychoacousticPrinciples}
	...
	feature can have on perceived timbre we must model how that feature itself is perceived. Several models have been
	proposed by research in psychoacoustics, a field which studies the perception of sound. The existing psychoacoustic
...
\label{sec:Timbre-Parameterisation}
	...
	\label{sec:Timbre-DimensionalityReduction-DimensionCorrelations}
		...
		\citet{alluri2010exploring} took a more in depth approach, using stepwise and principal components
