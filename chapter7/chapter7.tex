...
\label{sec:PerceptualExperiments-Reconstruction}
	...
	\label{sec:PerceptualExperiments-Reconstruction-Methodology}
		...
		\subsubsection*{Subjective Evaluation}
			...
			at once. They were asked to rate how well each of the stimuli recreate the reference stimuli (the
	...
	\label{sec:PerceptualExperiments-Reconstruction-Results}
		...
		The R\sub{nonlin} results for each of the stimuli are presented in Figure \ref{fig:SMCRNonlin}. The
		...
		\note
		{
			Note that for the piano stimuli some of the stimuli have a lower rnonlin than the anchor.
		}
