...
%
		...
		reconstruction of signals in which the amplitudes of the harmonics do not obey these relationships. The
		degree of inaccuracy introduced can be estimated by examining the relationships of the harmonics'
		...
		{
			\begin{itemize}
				\item Cello should possibly be the easiest to reconstruct but maybe its attack and decay
					cause lower reconstruction scores.
				\item Piano is really hard to reconstruct because of the fundamental being damped and not
					any of the other harmonics.
				\item Synth has a lot of variation in amplitude ratio but still receives high scores so
					perhaps the amplitude ratios are not important for perception.
				\item Clarinet receives similar scores to the cello, both are simple harmonically
					structured acoustic sounds.
			\end{itemize}
		}
