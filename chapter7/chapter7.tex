...
%
		...
		that of the fundamental ($\frac{h_{n}}{h_{1}}$). Depending on the source of the sound, and playing method
		if it was produced by an acoustic instrument, the relationships between the harmonics' amplitudes may be
		...
		\note
		{
			\begin{itemize}
				...
				\item In the cello all harmonics but the third have a shorter release than the
					fundamental.
