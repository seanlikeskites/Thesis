...
\label{sec:PerceptualExperiments-Reconstruction}
	...
	\label{sec:PerceptualExperiments-Reconstruction-Methodology}
		\subsubsection*{Stimuli Generation}
			...
			Eleven test stimuli were created from each of the four original signals. The first two being the
...
%
		...
		\subsubsection*{Harmonic Amplitude Ratios}
			...
			Better results might be achieved by using one of the higher order harmonics in the generation of
			...
			The degree of inaccuracy introduced can be estimated by examining the relationships of the
...
%		}
			...
			Figure~\ref{fig:SustainAmplitudes} shows the amplitude ratios, between the harmonics and $f_{0}$,
			...
			4\super{th}, 5\super{th} and 6\super{th} harmonics can be seen to rise rapidly, and the 3\super{rd}
			...
			Figure~\ref{fig:ReleaseAmplitudes} shows the amplitude ratios, between the harmonics and $f_{0}$,
			...
			however, the 3\super{rd} harmonic is the most dominant, being the last partial in the signal to
			decay fully. In the piano signal's release section (Figure~\ref{fig:PianoRelease}) the 3\super{rd}
		...
		\subsubsection*{Harmonic Variability}
			...
			\begin{figure}[h!]
				...
				\caption{Amplitude ratios, between the harmonics and $f_{0}$, in the sustain portion
					 of the clarinet signal, after being reconstructed with the synthesis technique.}
				\label{fig:STFTModulations}
			\end{figure}

			A window length of 50 samples does not provide the synthesis reconstruction system with enough
...
\label{sec:PerceptualExperiments-SemanticControl}
	...
	\label{sec:PerceptualExperiments-SemanticControl-EffectDesign}
		...
		\subsubsection*{Warmth / Brightness}
			...
			of the system shown in Figure~\ref{fig:TwoBandSpectralCentroidSystem}. Two spectral bands are
			created, one with a spectral centroid lower than the input signal and one with a higher spectral
			centroid. The relative levels of these bands are then adjusted in order to adjust the output's
	...
	\label{sec:PerceptualExperiments-SemanticControl-Discussion}
		\subsubsection*{Warmth / Brightness Effect}
			...
			The listening test results do not represent a difference between `bright' and `harsh', like that
		...
		\subsubsection*{Descriptor Clustering}
			...
			Across all three heat maps, the terms group into two main clusters, named for the most commonly
	...
	\label{sec:PerceptualExperiments-SemanticControl-Conclusion}
		...
		The results of the listening test, with the warmth / brightness effect, show that applying a low pass
