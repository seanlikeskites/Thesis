...
%
		...
		relationships between the amplitudes of harmonics and the fundamental in the test signals.
		...
		\begin{figure}[h!]
			...
			\caption{Amplitude ratios between the harmonics and fundamental in the attack
