...
\label{sec:PerceptualExperiments-Reconstruction}
	...
	\label{sec:PerceptualExperiments-Reconstruction-Results}
		...
		correctly causing their results have been discarded. The mean grading of the remaining six participants are
		shown in Figure \ref{fig:SMCRNonlin} with error bars representing the 95\% confidence interval.
