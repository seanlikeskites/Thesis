...
\label{sec:PerceptualExperiments-Conclusion}
	\note
	{
		Something along the lines of showing how the systems developed in Chapter \ref{chap:FeatureControl} can be
		built into useful systems. Whether it be for the reconstruction of degraded audio of for the application of
		creative audio effects. The resulting systems are provably accurate in terms of objective and subjective
		performance.

		More advanced perceptual control systems, perhaps with additional control parameters may perform better. Or
		perhaps a control interface which mimics the timbre space, a la Mr stasis the bad man.

		Then I guess summarise the conclusions of the two experiments.
	}
