...
%		}
		...
		correlation between scores and harmonic variability is not so definitive. Another factor sut be
		contributing the the low quality scores given to signals reconstructed using this method. Inspecting the
