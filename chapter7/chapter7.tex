...
%
		...
		assumed by the reconstruction systems can be measures as the sum of the standard deviations of each of the
		harmonic amplitude ratios. This harmonic variability (HV) is measured using Equation
		...
		stimulus test. Correlation values for each of the reconstruction systems and parameter settings are
		given in Table \ref{tab:HarmonicVariabilityCorrelations}.
