...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-TimbreSpaces}
		...
		\subsubsection*{Distortion Feature Differences}
			...
			Referring to the raw values of the feature difference, it is noted that the position of `warm',
			`cream' and `fuzz' in this PC is associated with a net decrease in these features. 
