...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-Agreement}
		...
		\subsubsection*{Low Variance}
			...
			using Equation \ref{eq:EigenvalueAgreement}, with $\lambda_{d,k}$ being the $k$\super{th}
			...
			The number of PCs to use in the calculation of agreement, $K$, will depend on the dataset being
	...
	\label{sec:TimbreEvaluation-Analysis-TimbreSpaces}
		...
		\subsubsection*{Distortion Processed Features}
			\begin{figure}[h!]
				...
				\subfloat[Descriptor Centroids]
				{
					\includegraphics[width=0.45\textwidth]
							{chapter4/Images/DistortionProcessedCentroidsPCA.eps}
			...
			\begin{table}[h!]
				...
				\begin{tabular}{|c|c|c|c|c|c|}
					...
					\hline
					\bf{Feature} & \bf{PC 1} & \bf{PC 2} & \bf{PC 3} & \bf{PC 4} & \bf{PC 5} \tabularnewline
					\hline
					\hline
					\bf{Krimphoff Irregularity} & \bf{-0.992} & -0.0154 & 0.0596 & -0.0023 & -0.0146 \tabularnewline
					\hline
					\bf{Peak Krimphoff Irregularity} & \bf{-0.985} & -0.0615 & 0.0341 & -0.078 & -0.0299 \tabularnewline
					\hline
					\bf{Harmonic Krimphoff Irregularity} & \bf{-0.968} & -0.0805 & 0.0128 & -0.118 & -0.0631 \tabularnewline
					\hline
					\bf{Peak Spectral Kurtosis} & \bf{-0.964} & -0.0649 & 0.0355 & -0.121 & -0.00483 \tabularnewline
					\hline
					\bf{Harmonic Spectral Kurtosis} & \bf{-0.959} & -0.0841 & 0.0247 & -0.143 & -0.04 \tabularnewline
					\hline
					\bf{Peak Spectral Skewness} & \bf{-0.957} & -0.116 & 0.0185 & -0.14 & -0.0177 \tabularnewline
					\hline
					\bf{Harmonic Spectral Skewness} & \bf{-0.946} & -0.144 & 0.0117 & -0.153 & -0.0577 \tabularnewline
					\hline
					\bf{Spectral Roll Off} & -0.0688 & \bf{0.938} & 0.0639 & -0.012 & -0.212 \tabularnewline
					\hline
					\bf{Harmonic Spectral Standard Deviation} & -0.00378 & \bf{0.933} & -0.033 & -0.0926 & -0.265 \tabularnewline
					\hline
					\bf{Peak Spectral Standard Deviation} & -0.00829 & \bf{0.932} & -0.0461 & -0.0911 & -0.257 \tabularnewline
					\hline
					\bf{Spectral Skewness} & \bf{-0.923} & -0.177 & -0.0676 & -0.204 & -0.0561 \tabularnewline
					\hline
					\bf{Signal Standard Deviation} & \bf{-0.919} & -0.209 & 0.0759 & -0.188 & -0.0899 \tabularnewline
					\hline
					\bf{RMS Amplitude} & \bf{-0.919} & -0.209 & 0.0761 & -0.188 & -0.0898 \tabularnewline
					\hline
					\bf{Peak Spectral Centroid} & 0.0215 & \bf{0.904} & -0.0364 & -0.0913 & -0.321 \tabularnewline
					\hline
					\bf{Harmonic Spectral Centroid} & 0.0279 & \bf{0.903} & -0.0348 & -0.107 & -0.328 \tabularnewline
					\hline
					\bf{Zero Crossing Rate} & 0.0335 & \bf{0.875} & -0.0179 & 0.0482 & -0.264 \tabularnewline
					\hline
					\bf{Spectral Centroid} & -0.0431 & \bf{0.856} & 0.311 & -0.159 & 0.0509 \tabularnewline
					\hline
					\bf{MFCC 1} & 0.151 & \bf{-0.851} & 0.103 & -0.275 & -0.0703 \tabularnewline
					\hline
					\bf{Signal Variance} & \bf{-0.851} & -0.092 & 0.0796 & -0.161 & -0.0518 \tabularnewline
					\hline
					\bf{Spectral Slope} & -0.0205 & \bf{0.827} & 0.293 & -0.231 & 0.116 \tabularnewline
					\hline
				\end{tabular}
				\caption{Correlations between audio features and PCs for Figure
		...
		\subsubsection*{Distortion Feature Differences}
			\begin{figure}[h!]
				...
				{
					\includegraphics[width=0.45\textwidth]
							{chapter4/Images/DistortionDifferenceCentroidsPCA.eps}
			...
			\begin{table}[h!]
				...
				\begin{tabular}{|c|c|c|c|c|c|}
					...
					\hline
					\hline
					\bf{Krimphoff Irregularity} & \bf{0.992} & 0.0493 & -0.003 & 0.000576 & 0.0412 \tabularnewline
					\hline
					\bf{Peak Krimphoff Irregularity} & \bf{0.989} & 0.064 & 0.0768 & 0.0347 & -0.0181 \tabularnewline
					\hline
					\bf{Harmonic Krimphoff Irregularity} & \bf{0.971} & 0.0637 & 0.153 & 0.0221 & -0.0384 \tabularnewline
					\hline
					\bf{Peak Spectral Skewness} & \bf{0.956} & 0.0643 & 0.152 & 0.0544 & -0.103 \tabularnewline
					\hline
					\bf{Peak Spectral Kurtosis} & \bf{0.956} & 0.0701 & 0.147 & 0.0586 & -0.0621 \tabularnewline
					\hline
					\bf{Harmonic Spectral Skewness} & \bf{0.943} & 0.0683 & 0.205 & 0.0448 & -0.101 \tabularnewline
					\hline
					\bf{Harmonic Spectral Kurtosis} & \bf{0.941} & 0.0696 & 0.212 & 0.0455 & -0.0608 \tabularnewline
					\hline
					\bf{Signal Standard Deviation} & \bf{0.939} & 0.112 & 0.126 & 0.0841 & -0.2 \tabularnewline
					\hline
					\bf{RMS Amplitude} & \bf{0.939} & 0.112 & 0.126 & 0.0844 & -0.199 \tabularnewline
					\hline
					\bf{Spectral Skewness} & \bf{0.918} & 0.0959 & 0.17 & 0.0445 & -0.266 \tabularnewline
					\hline
					\bf{Spectral Roll Off} & 0.194 & \bf{-0.913} & -0.00656 & 0.0844 & -0.053 \tabularnewline
					\hline
					\bf{Spectral Centroid} & 0.231 & \bf{-0.901} & -0.0802 & -0.115 & -0.0139 \tabularnewline
					\hline
					\bf{Signal Variance} & \bf{0.877} & 0.0899 & 0.0827 & -0.0276 & -0.233 \tabularnewline
					\hline
					\bf{Harmonic Spectral Standard Deviation} & 0.091 & \bf{-0.869} & 0.0437 & 0.352 & -0.0701 \tabularnewline
					\hline
					\bf{Harmonic Spectral Centroid} & 0.0801 & \bf{-0.832} & 0.0455 & 0.41 & -0.103 \tabularnewline
					\hline
					\bf{Peak Spectral Standard Deviation} & 0.0932 & \bf{-0.831} & 0.0612 & 0.362 & -0.0561 \tabularnewline
					\hline
					\bf{Peak Spectral Centroid} & 0.0857 & \bf{-0.83} & 0.0314 & 0.405 & -0.0904 \tabularnewline
					\hline
				\end{tabular}
				\caption{Correlations between audio features and PCs for Figure
		...
		\subsubsection*{Equaliser Processed Features}
			\begin{figure}[h!]
				...
				{
					\includegraphics[width=0.45\textwidth]
							{chapter4/Images/EqualiserProcessedCentroidsPCA.eps}
			...
			\begin{table}
				...
				\begin{tabular}{|c|c|c|c|c|c|}
					...
					\hline
					\hline
					\bf{Krimphoff Irregularity} & \bf{0.991} & -0.00908 & -0.0163 & -0.0271 & 0.00208 \tabularnewline
					\hline
					\bf{Peak Krimphoff Irregularity} & \bf{0.981} & 0.0136 & 0.00345 & -0.016 & -0.0059 \tabularnewline
					\hline
					\bf{Harmonic Spectral Kurtosis} & \bf{0.966} & -0.0367 & -0.0122 & -0.0182 & 0.00214 \tabularnewline
					\hline
					\bf{Peak Spectral Kurtosis} & \bf{0.962} & -0.091 & -0.0432 & 0.00876 & -0.0317 \tabularnewline
					\hline
					\bf{Harmonic Krimphoff Irregularity} & \bf{0.958} & 0.0774 & 0.0617 & -0.0553 & 0.0418 \tabularnewline
					\hline
					\bf{Spectral Skewness} & \bf{0.945} & -0.161 & -0.0671 & 0.0405 & -0.106 \tabularnewline
					\hline
					\bf{MFCC 8} & -0.0991 & -0.087 & -0.0509 & \bf{0.926} & 0.167 \tabularnewline
					\hline
					\bf{Harmonic Spectral Standard Deviation} & 0.0419 & \bf{0.922} & -0.0149 & 0.0823 & -0.122 \tabularnewline
					\hline
					\bf{Peak Spectral Standard Deviation} & 0.0438 & \bf{0.918} & -0.00506 & 0.0828 & -0.122 \tabularnewline
					\hline
					\bf{Spectral Roll Off} & -0.055 & \bf{0.895} & -0.231 & 0.0926 & -0.142 \tabularnewline
					\hline
					\bf{Peak Spectral Skewness} & \bf{0.895} & -0.198 & -0.123 & 0.0653 & -0.0901 \tabularnewline
					\hline
					\bf{Harmonic Spectral Skewness} & \bf{0.886} & -0.185 & -0.12 & 0.0529 & -0.0797 \tabularnewline
					\hline
					\bf{Spectral Kurtosis} & \bf{0.884} & -0.178 & -0.0346 & 0.0511 & -0.134 \tabularnewline
					\hline
					\bf{Harmonic Spectral Centroid} & 0.0567 & \bf{0.881} & -0.00673 & 0.021 & -0.176 \tabularnewline
					\hline
					\bf{Peak Spectral Centroid} & 0.0577 & \bf{0.881} & -0.00097 & 0.02 & -0.176 \tabularnewline
					\hline
					\bf{Signal Standard Deviation} & \bf{0.84} & -0.253 & -0.261 & 0.0156 & -0.161 \tabularnewline
					\hline
					\bf{RMS Amplitude} & \bf{0.84} & -0.253 & -0.261 & 0.0156 & -0.161 \tabularnewline
					\hline
					\bf{MFCC 10} & -0.0455 & -0.123 & 0.169 & \bf{0.839} & -0.00629 \tabularnewline
					\hline
					\bf{MFCC 9} & 0.0353 & -0.0111 & 0.273 & \bf{0.836} & 0.169 \tabularnewline
					\hline
					\bf{Signal Variance} & \bf{0.813} & -0.147 & -0.321 & 0.103 & -0.171 \tabularnewline
					\hline
					\bf{Spectral Centroid} & -0.152 & \bf{0.806} & -0.427 & 0.13 & -0.153 \tabularnewline
					\hline
					\bf{Spectral Slope} & -0.16 & \bf{0.805} & -0.434 & 0.138 & -0.124 \tabularnewline
					\hline
					\bf{MFCC 1} & -0.0782 & \bf{-0.802} & -0.292 & -0.0949 & 0.158 \tabularnewline
					\hline
				\end{tabular}
				\caption{Correlations between audio features and PCs for Figure
		...
		\subsubsection*{Equaliser Feature Differences}
			\begin{figure}[h!]
				...
				{
					\includegraphics[width=0.45\textwidth]
							{chapter4/Images/EqualiserDifferenceCentroidsPCA.eps}
					\label{fig:EqualiserDifferenceCentroidsPCA}
				}
			...
			\begin{table}
				...
				\begin{tabular}{|c|c|c|c|c|c|}
					...
					\hline
					\hline
					\bf{Krimphoff Irregularity} & \bf{-0.986} & 0.0935 & 0.00862 & -0.0212 & 0.0494 \tabularnewline
					\hline
					\bf{Peak Krimphoff Irregularity} & \bf{-0.97} & 0.141 & -0.0182 & -0.00184 & -0.0477 \tabularnewline
					\hline
					\bf{Spectral Skewness} & \bf{-0.968} & 0.0123 & 0.0418 & 0.0317 & -0.0479 \tabularnewline
					\hline
					\bf{Peak Spectral Kurtosis} & \bf{-0.932} & -0.0526 & 0.0688 & -0.00596 & 0.0933 \tabularnewline
					\hline
					\bf{Harmonic Krimphoff Irregularity} & \bf{-0.922} & 0.217 & -0.0777 & -0.039 & -0.00256 \tabularnewline
					\hline
					\bf{MFCC 12} & -0.00222 & 0.0141 & -0.199 & \bf{0.917} & 0.26 \tabularnewline
					\hline
					\bf{Spectral Kurtosis} & \bf{-0.915} & 0.0292 & 0.0391 & 0.0331 & -0.0483 \tabularnewline
					\hline
					\bf{Harmonic Spectral Kurtosis} & \bf{-0.912} & 0.033 & 0.00275 & -0.0506 & 0.16 \tabularnewline
					\hline
					\bf{MFCC 11} & 0.00263 & 0.0043 & -0.253 & \bf{0.908} & 0.273 \tabularnewline
					\hline
					\bf{MFCC 10} & -0.0101 & -0.047 & -0.3 & \bf{0.893} & 0.282 \tabularnewline
					\hline
					\bf{Signal Variance} & \bf{-0.89} & 0.0238 & 0.0881 & -0.00174 & 0.0374 \tabularnewline
					\hline
					\bf{Signal Standard Deviation} & \bf{-0.872} & -0.0618 & 0.0927 & -0.0603 & 0.265 \tabularnewline
					\hline
					\bf{RMS Amplitude} & \bf{-0.872} & -0.0619 & 0.0928 & -0.0603 & 0.265 \tabularnewline
					\hline
					\bf{Peak Spectral Centroid} & 0.119 & \bf{0.867} & -0.011 & -0.0399 & 0.0461 \tabularnewline
					\hline
					\bf{Harmonic Spectral Centroid} & 0.118 & \bf{0.863} & -0.00763 & -0.0414 & 0.0505 \tabularnewline
					\hline
					\bf{Peak Spectral Skewness} & \bf{-0.862} & -0.131 & 0.147 & 0.0279 & 0.0473 \tabularnewline
					\hline
					\bf{MFCC 9} & -0.0168 & -0.0779 & -0.42 & \bf{0.848} & 0.262 \tabularnewline
					\hline
					\bf{Harmonic Spectral Standard Deviation} & 0.163 & \bf{0.838} & -0.0583 & 0.0426 & 0.0615 \tabularnewline
					\hline
					\bf{Peak Spectral Standard Deviation} & 0.165 & \bf{0.833} & -0.053 & 0.046 & 0.0596 \tabularnewline
					\hline
					\bf{Harmonic Spectral Skewness} & \bf{-0.831} & -0.0913 & 0.113 & -0.00206 & 0.109 \tabularnewline
					\hline
					\bf{Spectral Roll Off} & 0.137 & \bf{0.813} & -0.0523 & -0.0892 & 0.109 \tabularnewline
					\hline
				\end{tabular}
				\caption{Correlations between audio features and PCs for Figure
