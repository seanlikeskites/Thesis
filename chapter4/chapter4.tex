...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-TimbreSpaces}
		...
		\subsubsection*{Distortion Processed Features}
			The salient features of the timbre space describing processed signals from the distortion are shown
			in Datum \ref{dat:DistortionProcessedCorrelations}.
		...
		\subsubsection*{Distortion Feature Differences}
			The salient features of the timbre space describing feature manipulations from the distortion are
			shown in Datum \ref{dat:DistortionDifferenceCorrelations}.
		...
		\subsubsection*{Equaliser Processed Features}
			The salient features of the timbre space describing processed signals from the equaliser are shown
			in Datum \ref{dat:EqualiserProcessedCorrelations}.
		...
		\subsubsection*{Equaliser Feature Differences}
			The salient features of the timbre space describing feature manipulations from the equaliser are
			shown in Datum \ref{dat:EqualiserDifferenceCorrelations}.
