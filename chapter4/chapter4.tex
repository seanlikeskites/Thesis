...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-Agreement}
		...
		\begin{equation}
			A(d) = \log(N_{d}) \sum_{k = 1}^{K} \frac{1}{\sigma_{d,k}^{2}}
			\label{eq:SumOfReciprocalAgreement}
		\end{equation}

		\begin{equation}
			A = \log(N_{d}) \sum_{k = 1}^{K} \frac{1}{\lambda_{d,k}}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{|c|c|c|c|}
				...
				\hline
				\hline
				\bf{1} & 2.2 & 21.1 & 21.4 \tabularnewline
				\hline
				\bf{2} & 55.8 & 539.3 & 566.6 \tabularnewline
				\hline
				\bf{3} & 3.3 & 378.7 & 382.3 \tabularnewline
				\hline
				\bf{4} & 2.9 & 40.9 & 245.9 \tabularnewline
				\hline
			\end{tabular}
