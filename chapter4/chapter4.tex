...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-Agreement}
		...
		\begin{itemize}
			\item It is assumed that high variance in any feature implies a disagreement. It may be
			      the case that a particular audio feature has no influence on the perception of a particular
			      timbre and as such a high variance in that feature should not adversely effect the agreement
			      score.
			\item It is assumed that low variance in any feature implies an agreement. It may be the case that
			      the audio material used for every transform exhibit a small variance in a particular feature.
			      In this case a small variance does not show an agreement between users, it describes an
			      underlying pattern in the audio material used.
			\item It assumes that all audio features are independent. It may be the case that users agree that a
			      particular descriptor describes a particular relationship between several audio features (e.g.
			      a spectral centroid lying at the 4\super{th} harmonic). Assuming each of the features are
			      independent ignores these relationships.
		\end{itemize}
		...
		\begin{equation}
			A = \ln(N_{d}) \sum_{k = 1}^{K} \frac{1}{\lambda_{d,k}}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{|c|c|c|c|}
				...
				\hline
				\hline
				\bf{1} & 2.5 & 23.5 & 24.1 \tabularnewline
				\hline
				\bf{2} & 47.0 & 475.0 & 497.0 \tabularnewline
				\hline
				\bf{3} & 3.0 & 351.5 & 358.6 \tabularnewline
				\hline
				\bf{4} & 2.7 & 34.9 & 274.5 \tabularnewline
				\hline
			\end{tabular}
