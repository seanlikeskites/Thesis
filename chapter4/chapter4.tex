...
\label{sec:TimbreEvaluation-DAWBasedTimbreEvaluation}
	...
	\label{sec:TimbreEvaluation-DAWBasedTimbreEvaluation-InDAW}
		...
		commonly used \acrshort{daw}s support plug-ins in one or more of these formats.
		...
		which extract this information have been developed. They have been released under the title \acrfull{safe}
		Plug-ins \footnote{The most recent versions of the \acrshort{safe} plug-ins can be downloaded from
		\href{http://www.semanticaudio.co.uk/projects/download/} {www.semanticaudio.co.uk/projects/download}.}.

	\subsection{\acrshort{safe} Plug-Ins}
	...
	\label{sec:TimbreEvaluation-DAWBasedTimbreEvaluation-SAFEOntology}
		...
		representing the application of a semantic transform to a set of input signals to produce a set of output
