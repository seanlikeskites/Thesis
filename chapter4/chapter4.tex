...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-Agreement}
		...
		\subsubsection*{Validation with Synthesised Data}
			...
			\ref{BoundedEigenvalueAgreement}.
		...
		\subsubsection*{Distortion Processed Features}
			\begin{itemize}
				\item {\bf{PC 1:}} Krimphoff Irregularity ($p = -0.992$), Peak Krimphoff Irregularity ($p =
					-0.985$), Harmonic Krimphoff Irregularity ($p = -0.968$), Peak Spectral Kurtosis
					($p = -0.964$), Harmonic Spectral Kurtosis ($p = -0.959$), Peak Spectral Skewness
					($p = -0.957$), Harmonic Spectral Skewness ($p = -0.946$), Spectral Skewness ($p =
