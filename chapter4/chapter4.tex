...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FeatureControl-Parameterisation-SpectralMoments}
		...
		\note
		{
			The other spectral moments are more difficult to parameterise.
			\begin{itemize}
				\item centroid and spread need to remain unchanged.
				\item Can use intuition about spectral shape to increase decrease them.
			\end{itemize}
		}
