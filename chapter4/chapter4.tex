...
\label{sec:FeatureControl-Systems}
	...
	\label{sec:FeatureControl-SpectralShaping}
		...
		discussed in Section \ref{sec:FeatureControl-Individuals}. This allows the majority of the harmonics to be
		excited in an efficient manner only using more complex processing where it is needed.
