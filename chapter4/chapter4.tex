		...
		\subsubsection*{Distortion Processed Features}
			\begin{itemize}
				\item {\bf{PC 1:}} $\textrm{KI}$ ($p = -0.992$), $\textrm{KI}_{\textrm{p}}$ ($p = -0.985$),
					...
					$\sigma$ ($p = -0.919$), $\textrm{RMS}$ ($p = -0.919$), $\sigma^{2}$ ($p =
					-0.851$), $\kappa_{\textrm{s}}$ ($p = -0.790$).
		...
		\subsubsection*{Distortion Feature Differences}
			\begin{itemize}
				\item {\bf{PC 1:}} $\textrm{KI}$ ($p = 0.992$), $\textrm{KI}_{\textrm{p}}$ ($p = 0.989$),
					...
					$\kappa_{\textrm{h}}$ ($p = 0.941$), $\sigma$ ($p = 0.939$), $\textrm{RMS}$ ($p =
					0.939$), $\gamma_{\textrm{s}}$ ($p = 0.918$), $\sigma^{2}$ ($p = 0.877$),
					$\kappa_{\textrm{s}}$ ($p = 0.744$).
		...
		\subsubsection*{Equaliser Processed Features}
			\begin{itemize}
				\item {\bf{PC 1:}} $\textrm{KI}$ ($p = 0.991$), $\textrm{KI}_{\textrm{p}}$ ($p = 0.981$),
					...
					$\kappa_{\textrm{s}}$ ($p = 0.884$), $\sigma$ ($p = 0.840$), $\textrm{RMS}$ ($p =
					0.840$), $\sigma^{2}$ ($p = 0.813$).
				\item {\bf{PC 2:}} $\sigma_{\textrm{h}}$ ($p =  0.922$), $\sigma_{\textrm{p}}$ ($p =
					...
					$\textrm{SSl}$ ($p =  0.805$), $\textrm{MFCC}_{1}$ ($p = -0.802$), $\textrm{ZCR}$
					($p =  0.798$), $\sigma_{\textrm{p}}^{2}$ ($p =  0.761$), $\sigma_{\textrm{h}}^{2}$
					($p =  0.761$), $T_{\textrm{p}2}$ ($p = -0.749$), $T_{2}$ ($p = -0.745$),
					$\textrm{SC}$ ($p = -0.720$).
		...
		\subsubsection*{Equaliser Feature Differences}
			\begin{itemize}
				\item {\bf{PC 1:}} $\textrm{KI}$ ($p = -0.986$), $\textrm{KI}_{\textrm{p}}$ ($p = -0.970$),
					...
					$\kappa_{\textrm{h}}$ ($p = -0.912$), $\sigma^{2}$ ($p = -0.890$), $\sigma$ ($p =
					-0.872$), $\textrm{RMS}$ ($p = -0.872$), $\gamma_{\textrm{p}}$ ($p = -0.862$),
					$\gamma_{\textrm{h}}$ ($p = -0.831$).
				\item {\bf{PC 2:}} $\mu_{\textrm{p}}$ ($p =  0.867$), $\mu_{\textrm{h}}$ ($p =  0.863$),
					$\sigma_{\textrm{h}}$ ($p =  0.838$), $\sigma_{\textrm{p}}$ ($p =  0.833$),
					$\textrm{SRO}$ ($p =  0.813$), $\mu_{\textrm{s}}$ ($p =  0.770$), $\textrm{SSl}$
					($p =  0.745$), $\textrm{MFCC}_{1}$ ($p = -0.705$).
