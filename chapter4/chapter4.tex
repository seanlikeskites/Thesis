...
\label{sec:FeatureControl-Systems}
	...
	\label{sec:FeatureControl-Individuals}
		...
		\note
		{
			Using static nonlinearities to create harmonically rich signals (odd, even order distortion and all
			that).

			Bigger system with individual harmonics for low orders and more general nonlinearities for the
			higher order components (over 9\super{th} harmonic), Figure \ref{fig:SpectralShapingSystem}.
