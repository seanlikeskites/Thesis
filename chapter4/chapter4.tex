	...
	\label{sec:FeatureControl-Systems-Superposition}
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}
				...
				\coordinate (Through) at (0, -4.5);
				\draw (InMid) -- (Through);
				\node (ThroughFilter) [draw] at (8, -4.5) {Filters};
	...
	\label{sec:FeatureControl-Systems-Inharmonicity}
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}
				...
				\coordinate (Through) at (0, -4.5);
				\draw (InMid) -- (Through);
				\node (ThroughFilter) [draw] at (8.5, -4.5) {Filters};
				\draw (Through) -- (ThroughFilter);
...
\label{sec:FeatureControl-Control}
	...
	\label{sec:FeatureControl-Control-SpectralMoments}
		...
		additional partials are introduced to the upper band such that its slope is unchanged the spectral centroid
		will be moved without altering the overall slope.
