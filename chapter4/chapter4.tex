...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-TimbreSpaces}
		...
		Additionally an impression of the spectral characteristics of each descriptor can be seen by examining the
		bark band coefficients in the feature space. When applied to the processed feature space this provides mean
		spectrum of the output signals described with a particular term. When applied in the feature difference
		space it provides the mean spectral manipulation applied by transforms associated with a particular term.
		...
		\subsubsection*{Distortion Processed Features}
			...
			From the analysis of Figure \ref{fig:DistortionProcessedPCAs} the PCs which best
			...
			described with the term `crunch' appears to sit at the top end of PC 2, it is known in actuality
			that this descriptor's position in PC 2 is not significant.
			...
			Looking at the mean spectra for the descriptors (Figure \ref{fig:DistortionProcessedSprectra}, the
			spectral effects of a descriptor's position in PC 2 can be seen. As the position in PC 2 increases
			so does the signals proportion of high frequency content. 

			\begin{figure}[h!]
				\centering
				\includegraphics{chapter4/Images/DistortionProcessedSpectra.pdf}
				\caption{The mean spectra of signals produced by the distortion.}
		...
		\subsubsection*{Distortion Feature Differences}
			...
			scores are shown in Table \ref{tab:DistortionDifferenceAgreements}.
			...
			The salient features for this timbre space are shown in Datum
			\ref{dat:DistortionDifferenceCorrelations}.
		...
		\subsubsection*{Equaliser Processed Features}
			...
			\begin{figure}[h!]
				...
				\caption{The mean spectra of signals produced by the equaliser.}
