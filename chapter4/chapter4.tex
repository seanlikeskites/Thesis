...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-Agreement}
		...
		\subsubsection*{Validation with Synthesised Data}
			...
			represent a set of points whose position is only defined in one audio feature, having high variance
			...
			tightly clustered in all features.
			...
			\begin{table}[h!]
				...
				\begin{tabular}{|c|c|c|c|}
					...
					\hline
					\hline
					\bf{1} & 2.6 & 25.0 & 25.2 \tabularnewline
					\hline
					\bf{2} & 59.6 & 571.7 & 584.9 \tabularnewline
					\hline
					\bf{3} & 2.6 & 394.0 & 396.9 \tabularnewline
					\hline
					\bf{4} & 2.6 & 29.2 & 140.7 \tabularnewline
					\hline
				\end{tabular}
