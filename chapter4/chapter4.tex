	...
	\label{sec:TimbreEvaluation-Analysis-TimbreSpaces}
		...
		\subsubsection*{Distortion Processed Features}
			...
			\begin{figure}[h!]
				...
				{
					\includegraphics{chapter4/Images/DistortionProcessedPCA.pdf}
					\label{fig:DistortionProcessedPCA}
				}
				\subfloat[Descriptor Centroids]
				{
					\includegraphics{chapter4/Images/DistortionProcessedCentroidsPCA.pdf}
		...
		\subsubsection*{Distortion Feature Differences}
			...
			\begin{figure}[h!]
				...
				\subfloat[Individual Transforms]
				{
					\includegraphics{chapter4/Images/DistortionDifferencePCA.pdf}
					\label{fig:DistortionDifferencePCA}
				}
				\subfloat[Descriptor Centroids]
				{
					\includegraphics{chapter4/Images/DistortionDifferenceCentroidsPCA.pdf}
		...
		\subsubsection*{Equaliser Processed Features}
			...
			\begin{figure}[h!]
				...
				\subfloat[Individual Transforms]
				{
					\includegraphics{chapter4/Images/EqualiserProcessedPCA.pdf}
					\label{fig:EqualiserProcessedPCA}
				}
				\subfloat[Descriptor Centroids]
				{
					\includegraphics{chapter4/Images/EqualiserProcessedCentroidsPCA.pdf}
		...
		\subsubsection*{Equaliser Feature Differences}
			...
			\begin{figure}[h!]
				...
				\subfloat[Individual Transforms]
				{
					\includegraphics{chapter4/Images/EqualiserDifferencePCA.pdf}
					\label{fig:EqualiserDifferencePCA}
				}
				\subfloat[Descriptor Centroids]
				{
					\includegraphics{chapter4/Images/EqualiserDifferenceCentroidsPCA.pdf}
					\label{fig:EqualiserDifferenceCentroidsPCA}
				}
