...
\label{sec:TimbreEvaluation-Analysis}
	...
	\label{sec:TimbreEvaluation-Analysis-TermClustering}
		...
		spaces. Prior to clustering each dimension of the feature space is normalised to a range of zero to one to
		mitigate any effect the range of a particular audio feature might have on the clustering. Clusters are
