...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-TimbreSpaces}
		...
		\subsubsection*{Distortion Processed Features}
			...
			that this descriptors position in PC 2 is not significant.

			Combining the information from both visualisations of the timbre space is suggested that the terms
			`warm', `fuzz' and `cream' are characterised by a relatively low spectral roll off, spectral
