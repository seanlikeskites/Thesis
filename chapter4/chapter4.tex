...
%		This figure is da baddest figure, ask your dyslexic down syndromed mother.
	...
	\label{sec:TimbreEvaluation-Analysis-Agreement}
		...
		\subsubsection*{Validation with Synthesised Data}
			...
			\citet{ripley1987stochastic}, using the covariance matrices shown in Data \ref{dat:ClusterMatrices}
			...
			\begin{data}[h!]
				...
				\subfloat[Cluster 4]
				{
					$\begin{bmatrix}
						...
						0 & 0 & 4 \\
					\end{bmatrix}$
					\label{fig:Cluster4Matrix}
				}
				\caption{The covariance matrices for the clusters shown in \ref{fig:SynthesisedData}.}
				\label{dat:ClusterMatrices}
			\end{data}
