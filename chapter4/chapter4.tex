...
\label{sec:FeatureControl-Parameterisation}
	...
	\label{sec:FetureControl-Parameterisation-Irregularity}
		...
		applying a filter to the amplitudes of the signals partials. This does not allow the irregularity to be set
		to a precise value but gives control over the direction in which the irregularity will change. Low pass
		filtering the partials' amplitudes will decrease the irregularity while a high pass filter will do the
		opposite.
...
\label{sec:FeatureControl-Control}
	...
	\label{sec:FeatureControl-Control-HarmonicParityRatio}
		...
		\ref{fig:HarmonicPartiySystem} all the harmonic content in the output signal is generated by the
