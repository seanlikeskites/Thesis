...
\begin{abstract}
	...
	algorithms (using higher order filters or longer spectral analysis windows) improves the quality of the
	reconstruction.
	...
	conducted analysing the changes to perceived timbre, and audio features, associated with the application of
	distortion and equalisation effects. This study utilises data collected using a novel methodology in which data is
	collected as part of the music production workflow. Four distinct timbral groups are identified (warmth, brightness,
	crunchiness and muddiness), each consisting of related semantic terms. The perceptual meanings of these semantic
	groups are uncovered by measuring how the low level features of signals are manipulated by the application of the
	effects. The distinctions between each of the groups are found to be highly correlated with several low level audio
	features.
