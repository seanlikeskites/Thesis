...
\label{sec:ExcitationEvaluation-Comparison}
	...
	\label{sec:ExcitationEvaluation-Comparison-Summary}
		\begin{table}[h!]
			\centering
			\begin{tabular}{|c|c|C{3cm}|c|c|c|c|}
				\hline
				...
				\hline
				\hline
				Static Nonlinearity & $\mathcal{O}(n)$ & Non-homogeneous & & & \tabularnewline
				\hline
				Rectifier & $\mathcal{O}(n)$ & Positive Homogeneous & & & \tabularnewline
				\hline
				Integrator & $\mathcal{O}(n)$ & Positive Homogeneous & & & \tabularnewline
				\hline
				Multiplier & $\mathcal{O}(n)$ & Non-Homogeneous & & & \tabularnewline
				\hline
				SSBA & $\mathcal{O}(n)$ & Non-Homogeneous & & & \tabularnewline
				\hline
				IAP & $\mathcal{O}(n)$ & Homogeneous when $h$ is odd, positive homogeneous otherwise.
				& & & \tabularnewline
				\hline
				Spectral Replicator & $\mathcal{O}(n)$ & LTV & & & \tabularnewline
				\hline
				Spectral Folding & $\mathcal{O}(n)$ & LTV & & & \tabularnewline
				\hline
				Spectral Stretch & $\mathcal{O}(n\log{n})$ & Homogeneous &
				& & \tabularnewline
				\hline
				STTR & $\mathcal{O}(n)$ & LTV & & & \tabularnewline
				\hline
			\end{tabular}
...
%			and reversed in time none of the amplitude information in the signal is lost. 
	...
	\label{sec:ExcitationEvaluation-Comparison-SpectralCharacteristics}
		...
		\subsubsection*{IAP}
			In contrast to the SSBA method, the IAP method provides little control over the bandwidth of the
