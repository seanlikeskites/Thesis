...
\label{sec:ExcitationEvaluation-Evaluation}
	...
	control over where energy is introduced into a signal's spectrum. The suitability of an algorithm for timbral
	control use is evaluated against the following criteria:
...
%		\item Naturalness.
	...
	\label{sec:ExcitationEvaluation-Evaluation-SpectralCharacteristics}
		% continue here
		The algorithms presented in Section \ref{sec:Excitation-Methods} all introduce new spectral content to
