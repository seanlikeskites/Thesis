...
\label{sec:ExcitationEvaluation-Introduction}
	...
	engineering are then discussed in Section \ref{sec:ExcitationEvaluation-Uses}. A list of criteria with which to evaluate
	harmonic excitation methods for use in real time timbral control is developed in Section
	\ref{sec:ExcitationEvaluation-Evaluation}.  Section \ref{sec:ExcitationEvaluation-Methods} then describes several methods for harmonic
...
\label{sec:ExcitationEvaluation-AnalysisOfNonlinearSystems}
	...
	which will be discussed in Section \ref{sec:ExcitationEvaluation-Analysis-Metrics}.
	...
	\ref{sec:ExcitationEvaluation-Analysis-Modelling}.

	\subsection{Objective Distortion Metrics}
	\label{sec:ExcitationEvaluation-Analysis-Metrics}
		...
		distortion as discussed in Section \ref{sec:ExcitationEvaluation-Timbre}.

	\subsection{Nonlinear Modelling}
	\label{sec:ExcitationEvaluation-Analysis-Modelling}
...
\label{sec:ExcitationEvaluation-Timbre}
...
\label{sec:ExcitationEvaluation-Uses}
	...
	\ref{sec:ExcitationEvaluation-Uses-Reconstruction} through \ref{sec:ExcitationEvaluation-Uses-Enhancement}. While popular creative
	...
	\label{sec:ExcitationEvaluation-Uses-Reconstruction}
	...
	\label{sec:ExcitationEvaluation-Uses-Reinforcement}
	...
	\label{sec:ExcitationEvaluation-Uses-Enhancement}
...
\label{sec:ExcitationEvaluation-Evaluation}
	Harmonic excitation algorithms developed for the applications discussed in the Section \ref{sec:ExcitationEvaluation-Uses}
	...
	These criteria are then used to asses various algorithms in Section \ref{sec:ExcitationEvaluation-Methods}. 
...
%		\item Naturalness.
	...
	\label{sec:ExcitationEvaluation-Evaluation-Homogeneity}
		...
		In section \ref{sec:ExcitationEvaluation-Methods} the homogeneity of various nonlinear systems is discussed. For
