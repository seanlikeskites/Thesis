...
\label{sec:ExcitationEvaluation-Comparison}
	...
	\label{sec:ExcitationEvaluation-Comparison-Homogeneity}
		...
		\subsubsection*{Rectification}
			...
			$a$ the right hand side of the equation is the additive inverse of the left hand side. This has
		...
		\subsubsection*{SSBA}
			...
			order automodulation is the amplitude envelope of the original signal raised to the power $h$ as
			shown in Equation \ref{eq:SSBAHomogeneity}.

			\begin{equation}
				\Re \left( (ax_{a}[n])^{h} \right) = a^{h} \Re \left( x_{a}^{h}[n] \right)
