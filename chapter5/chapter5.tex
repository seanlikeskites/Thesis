...
%		\item Naturalness.
	...
	homogeneity and flexibility describing how well those can be utilised in a creative effect. Further detail on the
	...
	\label{sec:ExcitationEvaluation-Evaluation-Homogeneity}
		...
		positive values of $a$). A number of the systems evaluates are linear time variant and therefore
...
\label{sec:ExcitationEvaluation-Comparison}
	...
	\label{sec:ExcitationEvaluation-Comparison-Homogeneity}
		...
		\subsubsection*{Integrator}
			...
			signal also determines the points at which the output output signal is reset to zero. The signal is
			reset on positive going zero crossings but a negative gain before in the input reverses the
