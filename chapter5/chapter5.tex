...
\label{sec:ListeningTests-LaboratoryListeningTests}
	...
	\subsection{Multiple Stimuli Tests}
		...
		\note
		{
			MUSHRA initially developed for lossy compression codecs, use in a lot of bandwidth extension papers.
			Also used in some timbral papers \citep{arthi2015influence}.
		}
