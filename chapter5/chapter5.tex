...
\label{sec:ExcitationEvaluation-Comparison}
	...
	\label{sec:ExcitationEvaluation-Comparison-Homogeneity}
		...
		\subsubsection*{Spectral Replication}
			Showing that spectral replication using Equation \ref{eq:SpectralReplication} is a homogeneous
			system is trivial due to the associative property of multiplication.
