...
%		\item Naturalness.
	...
	ideal characteristics within these areas is discussed in Sections
...
\label{sec:ExcitationEvaluation-Comparison}
	...
	\label{sec:ExcitationEvaluation-Comparison-Homogeneity}
		\subsubsection*{Static Nonlinearities}
			...
			manner, the characteristic curve of the clipper can be scaled so it always clips the same
			proportion of the signal, as suggested by \citet{deman2014adaptive}.
...
%			and reversed in time none of the amplitude information in the signal is lost. 
	...
	\label{sec:ExcitationEvaluation-Comparison-TemporalCharacteristics}
		...
		\subsubsection*{\acrshort{ssba}}
			...
			The output is a sinusoid with three times the frequency and an amplitude envelope which is equal to
			the input's cubed. This is in contrast to the effect of the multiplier shown in
		...
		\subsubsection*{Spectral Replication}
			...
			signal's amplitude envelope caused by shifting it's frequency content upwards by 1.5Hz
